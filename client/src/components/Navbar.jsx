       ...
       <div>
        ...
        <div className='flex items-center gap-2 sm:gap-3'>
          <button className='flex items-center gap-2 bg-blue-100 px-4 sm:px-6 sm:py-3 rounded-full hover:scale-105 transition-all duration-200'>
            ...
            <p className='text-xs sm:text-sm '>Hi, {user.name}</p>
        ...
        <div className=' flex items-center gap-2 sm:gap-5 '>
            ...
            <button onClick={()=>setShowLogin(true)} className='bg-zinc-800 cursor-pointer text-white px-7 py-2 sm:px-10 text-sm  rounded-full '>
              Login</button>
        </div>
        }
